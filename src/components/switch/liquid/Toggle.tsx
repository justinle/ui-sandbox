        ...
        <label className={styles.switch}>
            ...
            <div className={styles.slider}>
                <div className={styles.circle}>
                    <svg className={styles.cross} viewBox="0 0 365.696 365.696" y="0" x="0" height="6" width="6" version="1.1"
                    ...
                    <svg className={styles.checkmark} viewBox="0 0 24 24" y="0" x="0" height="10" width="10" version="1.1"
                         xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <path data-original="#000000" fill="currentColor"
